                ...
                <table>
                    ...
                    <tbody>
                        <?php foreach ($multas as $multa) { ?>
                            <tr>
                                <td data-label="Identificación"><?php echo $multa['mul_fecha']; ?></td>
                                <td data-label="Fecha Actual"><?php echo $multa['mul_monto']; ?></td>
                                <td data-label="Lectura Actual"><?php echo $multa['mul_descrip']; ?></td>
